...
def handle_message(event):
    ...
    with ApiClient(configuration) as api_client:
        ...
        if text == 'profile':
        ...
        elif text == "振銓的女友" or text == "振銓的女朋友" or text == "振銓女友" :
            ...
            line_bot_api.reply_message(
                ReplyMessageRequest(
                    reply_token=event.reply_token,
                    messages=[TextMessage(text=movie_ranking)]
                )
            )
            ...
            line_bot_api.reply_message(
                ReplyMessageRequest(
                    reply_token=event.reply_token,
                    messages=[TextMessage(text=string)]
                )
            )
        # elif ans == '電扇開':
        #     fan_control("1")
        ...
        #     line_bot_api.reply_message(event.reply_token,TextSendMessage(text=reply_msg))
            ...
            image_url = temp[random.randint(0,len(temp)-1)]
            line_bot_api.reply_message(
                ReplyMessageRequest(
                    reply_token=event.reply_token,
                    messages=[
...
def handle_postback(event):
        ...
        # =================    搖桿功能圖    =============================================================
                ...
                image_url='https://i.imgur.com/kD4D0Zi.jpg',
                line_bot_api.reply_message(
                    ReplyMessageRequest(
                        reply_token=event.reply_token,
                        messages=[
